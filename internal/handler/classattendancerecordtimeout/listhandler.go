package classattendancerecordtimeout
...
import (
	...
	"edumaster/internal/logic/classattendancerecordtimeout"
...
func ListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClassAttendanceRecordTimeoutListReq
		...
		l := classattendancerecordtimeout.NewListLogic(r.Context(), svcCtx)
		resp, err := l.List(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
