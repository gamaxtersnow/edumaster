package classabsencenotification
...
import (
	...
	"edumaster/internal/logic/classabsencenotification"
...
func ListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClassAbsenceNotificationListReq
		...
		l := classabsencenotification.NewListLogic(r.Context(), svcCtx)
		resp, err := l.List(&req)
		if err != nil {
